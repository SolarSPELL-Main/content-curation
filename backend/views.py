...
from backend.standardize_format import build_response,standard_exception_handler
...
class StandardDataView:
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            response = standard_exception_handler(validationerror,request)
            return response
            
        except Exception as exc:
            response = standard_exception_handler(exc,request)
            return response
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            response = standard_exception_handler(request, exc)
        return response
